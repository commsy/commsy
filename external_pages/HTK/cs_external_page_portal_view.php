...
#      $retour .= '<html xmlns="http://www.w3.org/1999/xhtml">'.LF;
   ...
   function _getIncludedCSSAsHTML(){
      ...
      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/stylesheet_01b36e6ef2.css"/>'.LF;
   ...
   function getSearchBoxAsHTML(){
      ...
      $html .= '<div class="search_box" style="margin-top:20px;">'.LF;
      ...
      $html .= '<input style="width:145px; margin-top:20px;" name="option" value="Raum suchen" type="submit"/>'.LF;
...
$html.='<body>
    ...
    <div id="header">
        <div class="wrapper">
            <a href="" title="Startseite" id="portal_logo"><img src="css/external_portal_styles/'.$current_portal->getItemID().'/htk_logo.gif" alt="Hochtaunus Kliniken gGmbH"></a> <!-- verlinken mit der Startseite -->
            <img id="portal_claim" alt="Handeln mit Kompetenz und Menschlichkeit." src="css/external_portal_styles/'.$current_portal->getItemID().'/htk_claim.gif">
    ...
    <div id="main_navigation">
        <div class="wrapper">
            <ul>' .
            	...
            	'<li><a href="'.$commsy_path.'commsy.php?cid=1643009" target="_self">Dokumentenablage</a></li>' .
            	...
            	'<li><a href="'.$commsy_path.'commsy.php?cid=1643009&mod=material&fct=index&seltag=1643015" target="_self">Dienstanweisungen</a></li>' .
            	'</ul>
...
$html .='
    ...
    <div id="site_footer">
        <div class="wrapper">
            ...
            <p>© 2013 Hochtaunus Kliniken gGmbH, Bad Homburg v.d.H.</p>
        </div>
    </div>
