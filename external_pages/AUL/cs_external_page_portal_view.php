...
#        $html .= '</div>'.LF;
  ...
  function _getTableheadAsHTML($room_list_view) {
      ...
      if ($room_list_view->_environment->inPortal()) {
         ...
         $html .= '      <td colspan="2" class="portal-head" style="font-size: 12pt; width:45% padding: 5px;">'.LF;
         ...
         $html .= '      </td>'.LF;
         if ($room_list_view->_environment->inPortal()) {
            $html .= '      <td class="portal-head" style="font-size: 10pt; padding: 5px; width:30%">'.LF;
            $html .= '<span class="portal_link">'.$room_list_view->_translator->getMessage('CONTEXT_MODERATOR').'</span>'.LF;
            $html .= '      </td>'.LF;
         }

         $html .= '      <td class="portal-head" style="font-size: 10pt; padding: 5px; width:20%">'.LF;
   ...
   function asHTML(){
    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul id="main_navigation">
                <li><a href="http://www.mobilitaetsagentur-hamburg.de" id="home_normal" target="_blank">&nbsp;</a></li>
                <li><a href="http://www.mobilitaetsagentur-hamburg.de/teilnehmer" class="mn_normal" target="_blank">Teilnehmer</a></li>
                <li><a href="http://www.mobilitaetsagentur-hamburg.de/akteure-der-berufsbildung" class="mn_normal" target="_blank">Akteure der Berufsbildung</a></li>
                <li><a href="http://www.mobilitaetsagentur-hamburg.de/europaeische-partner" class="mn_normal" target="_blank">Europ&auml;ische Partner</a></li>
                <li><a href="http://www.mobilitaetsagentur-hamburg.de/interkulturelles-training" class="mn_normal" target="_blank">Interkulturelles Training</a></li>
                <li><a href="http://www.mobilitaetsagentur-hamburg.de/mobilitaet-durch-partnerschaften" class="mn_normal" target="_blank">Mobilit&auml;t durch Partnerschaften</a></li>
                <li><a href="http://www.mobilitaetsagentur-hamburg.de/aktuelles" class="mn_normal" target="_blank">Aktuelles</a></li>
            </ul>
    ...
    <div id="main_content">
        <div class="wrapper">
            ...
            <div id="left_column">
                <div class="lc_portlet">
                    <div class="lc_portlet_content">
    ...
    if ($current_user->isUser()){
       ...
       $html .='<div>'.LF;
       $html .='<h2>'.getMessage('PORTAL_OPEN_ROOM').'<h2>'.LF;
...
$html.='                    <div class="clear"></div>
    ...
    <div id="footer">
        <div class="wrapper">
            ...
            <div id="footer_links">
                <a href="">Kontakt &amp; Anfahrt</a> | <a href="">Presse</a> |
                <a href="">Datenschutz</a> | <a href="">Impressum</a> |
                <a href="">AGB</a> | <a href="">Sitemap</a>
            </div>

            <div id="footer_logos">
                <a href="" id="logo_eu">&nbsp;</a>
                <a href="" id="logo_aul">&nbsp;</a>
                <a href="" id="logo_hib">&nbsp;</a>
                <a href="" id="logo_hh">&nbsp;</a>
