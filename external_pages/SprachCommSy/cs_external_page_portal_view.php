...
class cs_external_page_portal_view extends cs_page_view {
   ...
   function _getSystemInfoAsHTML(){
      ...
      $html .= '&nbsp;&nbsp;<a href="http://www.commsy.net" target="_top" title="'.$this->_translator->getMessage('COMMON_COMMSY_LINK_TITLE').'">CommSy '.getCommSyVersion();
      $html .=  '</a>';
      $html .= '</div>'.LF;
      $html .='</div>'.LF;
      return $html;
      ...
      if ($mode !='member' and $mode !='info' and $mode !='email'){
         ...
         //als Gast Zutritt erlaubt, aber kein Mitglied
            ...
            $actionCurl = curl( $item->getItemID(),
                             ...
                             'index',
                             '');
            $html .= '<div style="padding-top:5px; font-size:8pt;">'.'> <a href="'.$actionCurl.'">'.$this->_translator->getMessage('CONTEXT_ENTER_AS_GUEST').'</a></div>'.LF;
            if ($item->isOpen()) {
               $params = array();
               $params = $this->_environment->getCurrentParameterArray();
...
#      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/hamburg-de.css"/>'.LF;
      ...
      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/b_uhh.css"/>'.LF;
      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/b_standard.css"/>'.LF;
      $retour .= '   <link rel="stylesheet" media="print" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/b_print.css"/>'.LF;
   ...
   function getSearchBoxAsHTML(){
      ...
      if ( isset($this->_room_list_view) ) {
         $html .= '<input style="width:'.$width.'; font-size:10pt; margin:5px 0px 3px 0px;" name="search" type="text" size="20" value="'.$this->_text_as_form($this->_room_list_view->getSearchText()).'"/>'.LF;
      } else {
         $html .= '<input style="width:'.$width.'; font-size:10pt; margin:5px 0px 3px 0px;" name="search" type="text" size="20" value=""/>'.LF;
      }
   ...
   function _getUserPersonalAreaAsHTML () {
      ...
      $retour .= '         <select size="1" style="font-size:10pt; width:187px;" name="room_id" onChange="javascript:document.room_change.submit()">'.LF;
      $context_array = array();
         ...
         if ( !empty($this->_current_user) and ($this->_current_user->getUserID() == 'guest' and $this->_current_user->isGuest()) and !$this->_environment->inServer() ) {
            ...
            if ( !$this->_environment->inServer() ) {
               ...
               if ( $count_auth_source_list_add_account != 0 ) {
                  $params['cs_modus'] = 'portalmember';
#                  $html .= '<span style="font-size:10pt;">&gt; <a style="display: inline;" href="'.$wiki_url.'Hilfe.NeueKennung">Neue Kennung beantragen</a></span>'.BRLF;
...
#         $html .= $this->_room_list_view->getPortalActionsAsHTML();
   ...
   function asHTML(){
    ...
    $html .= '<body id="ie">';
    $html .= '<a name="top"></a><span class="hh">|</span>
    <a href="http://www.uni-hamburg.de/browserinfo.html" class="browserinfo">Informationen zur Darstellung dieser Seite in älteren Browsern</a><span class="hh">|</span>
       <div id="kopf">
         <a id="logo_uhh" href="http://www.uni-hamburg.de/" title="Home"><img src="http://www.uni-hamburg.de/onTEAM/admin/onteam/_grafik/logos/UHH-Logo2010.png" alt="Logo der Universität Hamburg" border="0"/></a><span class="hh">|</span><a id="logo_rechts" href="http://www.uni-hamburg.de/Einrichtungen/vhs/" accesskey="1" title="Home"><img src="http://www.uni-hamburg.de/onTEAM/admin/onteam/_grafik/fb_logo/vhs.jpg" alt="VHS - Allgemeinsprachen" border="0"/></a><span class="hh">|</span>
       </div>
    <hr class="hide"/>

    <div id="navigation">
      <div class="pad">
          <!--<div id="pfad"><span class="hide">Sie sind hier: </span> <span class="paththispage">Allgemeinsprachen</span>
          </div>-->

          <div id="pfad"><span class="hide">Sie sind hier: </span> <A HREF="http://www.uni-hamburg.de/Einrichtungen/vhs/index.html"   CLASS="apath">Allgemeinsprachen</A> <SPAN CLASS="pathseparator"> &gt; </SPAN> <a href="'.curl($this->_environment->getCurrentPortalID(),"home","index",array()).'" class="apath">CommSy-Portal</a></div>

          <div class="toolbar"><span class="hide">Wichtige Links: </span><span class="hh">|</span><a href="http://www.uni-hamburg.de/sitemap.htm" accesskey="2" title="Sitemap anzeigen"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/sitemap-0.gif" alt="Sitemap anzeigen" width="23" border="0" height="15" hspace="2"/></a><span class="hh">|</span><a href="http://www.uni-hamburg.de/Dienste/Such/index.html" accesskey="4" title="Suche"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/search-0.gif" alt="Suche" width="17" border="0" height="15"/></a><span class="hh">|</span><a href="http://www.uni-hamburg.de/onTEAM/tree/" title="Campus-Navigator" target="_blank"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/campus.gif" alt="Campus-Navigator" width="15" border="0" height="15" hspace="2"/></a><hr class="hide"/><span class="hide">Sprache:</span><span class="sprache"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/search-0.gif" alt="" border="0" width="6" height="1"/></span><hr class="hide"/><span class="hide"><b>Blättern: </b></span><span class="blaettern"><a href="#bottom" title="Seitenende"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/down.gif" alt="Seitenende" vspace="1" width="13" border="0" height="13"/></a><span class="hh">|</span><a href="http://www.uni-hamburg.de/fachsprachenzentrum/kontakt.html" title="Zur vorangehenden Seite"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/previous.gif" alt="Zur vorangehenden Seite" vspace="1" width="13" border="0" height="13" hspace="2"/></a><span class="hh">|</span><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/index.html" title="Zur nächsten Seite"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/next.gif" alt="Zur nächsten Seite" vspace="1" width="13" border="0" height="13"/></a></span>
          </div>
          <div class="clear">&nbsp;
          </div>
      </div>
    ...
    <div id="container">
      <hr class="hide"/>
        <div id="subnavigation">
         <span class="hide"><b>Weiterführende Links:</b></span>
         <div class="pad">
          <ul>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/aktuelles.html" class="anav">Aktuelles &amp; Termine</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/einstufung.html" class="anav">Einstufung</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/BeWeTpWiSe08.html" class="anav">Bewerbung</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/programm.html" class="anav">Programm</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/teilnahme.html" class="anav">Rahmenbedingungen</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/zertifikate.html" class="anav">Leistungsbescheinigungen</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/kooperationspartner.html" class="anav">Sprachzertifikate und Prüfungszentren</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/lehrplaene.html" class="anav">Lehrpläne</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/kursmaterial.html" class="anav">Kursmaterial</a></li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/kontakt.html" class="anav">Kontakt</a></li>
            <li class="trenner">&nbsp;</li>
            <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/DaF.html" class="anav">Deutsch als Fremdsprache</a></li>
            <li class="trenner">&nbsp;</li>
            <li class="tree intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/sprachcommsy.html" class="anav">SprachCommSy</a></li>
            <ul class="tree">
               <li class="hereweare extern"><a href="http://www.sprachcommsy.uni-hamburg.de/" class="anav">Raumübersicht</a></li>
               <li class="intern"><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/ersteschritte.html" class="anav">Erste Schritte</a></li>
            </ul>
            <li class="ende">&nbsp;</li>
          </ul>
         </div>
       ...
       <div id="inhalt" class="mit">
        <span class="hide">Inhalt:</span>
            <!--<INPUT>-->'.LF;
...
$html .= '  <!--</INPUT>-->
   ...
   <hr class="hide"/>
   <div id="fuss">
     <div id="info"><span class="hide">Seiteninfo: </span><a href="http://www.uni-hamburg.de/impressum.html" accesskey="8">Impressum</a>&nbsp;| <a href="http://www.verwaltung.uni-hamburg.de/browserinfo.html">Browserinfo</a>&nbsp;|&nbsp;&nbsp;<a href="http://www.commsy.net" target="_top" title="'.$this->_translator->getMessage('COMMON_COMMSY_LINK_TITLE').'">CommSy '.getCommSyVersion().'</a></div>
     <div class="toolbar"><span class="hide"><b>Blättern: </b></span><span class="blaettern"><a href="#top" title="Seitenanfang"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/top.gif" alt="Seitenanfang" vspace="1" width="13" border="0" height="13"/></a><span class="hh">|</span><a href="http://www.uni-hamburg.de/fachsprachenzentrum/kontakt.html" title="Zur vorangehenden Seite"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/previous.gif" alt="Zur vorangehenden Seite" vspace="1" width="13" border="0" height="13" hspace="2"/></a><span class="hh">|</span><a href="http://www.uni-hamburg.de/Einrichtungen/vhs/index.html" title="Zur nächsten Seite"><img src="css/external_portal_styles/'.$current_context->getItemID().'/images/next.gif" alt="Zur nächsten Seite" vspace="1" width="13" border="0" height="13"/></a></span></div>
     <div class="clear">&nbsp;</div>
   </div>
   <a name="bottom"></a>'.LF;
