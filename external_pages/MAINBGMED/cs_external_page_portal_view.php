...
#      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/hamburg-de.css"/>'.LF;
      ...
      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/styles.css"/>'.LF;
      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/panel.css"/>'.LF;
      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/stylesheet.css"/>'.LF;
#      $current_browser = mb_strtolower($this->_environment->getCurrentBrowser(), 'UTF-8');
#      $current_browser_version = $this->_environment->getCurrentBrowserVersion();
...
#      }
   ...
   function getSearchBoxAsHTML(){
      ...
      $html .= '<div class="field_item">';
      if ( isset($this->_room_list_view) ) {
         $html .= '<input name="search" type="text" size="20" value="'.$this->_text_as_form($this->_room_list_view->getSearchText()).'"/>'.LF;
      } else {
         $html .= '<input name="search" type="text" size="20" value=""/>'.LF;
      }
      ...
      $html .= '<input style="font-size:8pt;" name="option" value="Raum suchen" type="submit"/>'.LF;
...
//if ( !$this->_environment->inPortal() || $this->_current_user->isGuest()) {
      ...
      if ( $this->_with_personal_area and empty($cs_mod)) {
         if ( !empty($this->_current_user) and ($this->_current_user->getUserID() == 'guest' and $this->_current_user->isGuest()) and !$this->_environment->inServer() ) {
            ...
            $html .= '<label>'.$this->_translator->getMessage('MYAREA_PASSWORD').':</label>'.LF;
            $html .= '<div class="field_item">'.LF;
            $html .= '<input type="password" name="password" tabindex="2"/>'.LF;
            $html .= '</div>'.LF;
...
*/            unset($auth_source_list);
            ...
            $html .= '<div class="form_actions">'.LF;
            $html .= '<br/><input type="submit" name="option" style="width: 10.8em;" value="'.$this->_translator->getMessage('MYAREA_LOGIN_BUTTON').'" tabindex="4"/>'.LF;
            $html .= '</div>'.LF;
            #$html .= '</td></tr>'.LF;
            #$html .= '</table>'.LF;
            $html .= '</form>'.LF;
...
$html .='<body>
    <div id="reha_main">
        <div id="wrapper">
            <div id="company_choose"><p>Bereich wählen</p><a href="http://www.main-bgmed.de/startseite.html" onfocus="blurLink(this);" id="fb_company_main"><span>MAIN•BGMED</span></a><a href="http://www.main-bgmed-rehazentrum.de/startseite.html" onfocus="blurLink(this);" id="fb_company_05_active"><span>Rehazentrum</span></a><a href="http://www.mainbgmed-mvz.de/startseite.html" onfocus="blurLink(this);" id="fb_company_mvz"><span>MAIN•BGMED MVZ</span></a><div class="clear"></div></div>
                <div id="portal_logo"><a href="commsy.php?cid='.$this->_environment->getCurrentPortalID().'"><img src="http://www.main-bgmed-rehazentrum.de/fileadmin/templates/img/logo_rehazentrum.gif" alt="MAIN BGMED" border="0" height="97" width="160"></a></div>
         ...
         <div id="content_area_wrapper">
             <div id="content_area">
                    <div id="maincontent">
                        ...
                        <div id="mc_columnset" style="background: url(http://www.main-bgmed-rehazentrum.de/fileadmin/templates/img/header_follow_01.jpg) no-repeat top left;;"> <!-- Hintergrundbild hier einsetzen -->

                            <div id="mc_left_column">
                                <div id="here_sitecontent">'.LF;
...
# Hauptbereich, der zu füllen ist.
      ...
      elseif ($cs_room_id and $cs_module == 'configuration' ){
         ...
         if ($cs_module == 'account'){
            $html .='<div style="background-color:white; font-size:8pt; padding:10px;">';
...
$html .='
                            ...
                            <div id="mc_right_column">

                                <div id="contact_col">
	<!--  CONTENT ELEMENT, uid:43/templavoila_pi1 [begin] -->
		<div id="c43" class="csc-default"><div id="contact_area">
        '.LF;
	...
	$html .= '<h2>Anmeldung/Raumsuche</h2>
        <h4>Anmeldung am Intranet.</h4>
...
$html.='        </div>
	...
	<!--  CONTENT ELEMENT, uid:43/templavoila_pi1 [end] -->
		</div>



                                <div id="teaser_area"></div>
            ...
            <!--TYPO3SEARCH_end-->
            <div id="footer"><p id="copyright">© 2012&nbsp;<a href="http://www.main-bgmed.de/startseite.html">MAIN•BGMED</a>&nbsp;<br><a href="http://www.main-bgmed-rehazentrum.de/impressum.html" onfocus="blurLink(this);">Impressum</a>&nbsp;|&nbsp;<a href="http://www.main-bgmed-rehazentrum.de/sitemap.html" onfocus="blurLink(this);">Sitemap</a></p></div>
