 ...
 */
class cs_color_configuration_form_view extends cs_configuration_form_view {
    ...
    */
   function cs_color_configuration_form_view ($environment, $with_modifying_actions = true) {
