 ...
 */
class cs_form_view_left extends cs_view {
   ...
   */
    ...
    */
   function cs_form_view_left ($environment, $with_modifying_actions = true) {
  ...
  /** internal method to create errorbox if there are errors, INTERNAL
   ...
   function _getErrorBoxAsHTML () {
      ...
      $errorbox = new cs_errorbox_view($this->_environment,true,'100%');
      $first = true;
      $error_string = '';
