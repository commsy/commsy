...
class cs_user_detail_view extends cs_detail_view {
    ...
    */
   function cs_user_detail_view ($environment, $with_modifying_actions=true,$creatorInfoStatus=array()) {
      $this->cs_detail_view($environment, 'user', $with_modifying_actions,$creatorInfoStatus);
   }
