...
class cs_institution_detail_view extends cs_detail_view {
    ...
    */
   function cs_institution_detail_view ($environment, $with_modifying_actions=true,$creatorInfoStatus=array()) {
      $this->cs_detail_view($environment, 'institution', $with_modifying_actions,$creatorInfoStatus);
   }
   ...
   function _getDetailActionsAsHTML ($item) {
      ...
      if ( !$this->_environment->inPrivateRoom() ){
         ...
         // Enter or leave the institution
