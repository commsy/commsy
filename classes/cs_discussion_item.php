...
class cs_discussion_item extends cs_item {
  ...
  /** set groups of a discussion
   * this method sets a list of groups which are linked to the discussion
   *
   * @param string value title of the discussion
   *
   * @author CommSy Development Group
  ...
  /** set groups of a discussion item by id
   * this method sets a list of group item_ids which are linked to the discussion
   *
   ...
   */
   function setGroupListByID ($value) {
      ...
      $this->_setValue(CS_GROUP_TYPE, $group_data, FALSE);
   }

  /** get groups of a discussion
   * this method returns a list of groups which are linked to the discussion
   *
