 ...
 */
include_once('classes/cs_page_view.php');
 ...
 */
class cs_page_pda_view extends cs_page_view {
    ...
    */
   function cs_page_pda_view ($environment, $with_modifying_actions = true) {
...
/*    function _getAllOpenContexts () {
   ...
   function asHTML () {
	  ...
	  if ( !$this->_blank_page ) {
         ...
         $html .= '>'.LF;
	      $html .= LF.'<table style="border-collapse:collapse; padding:0px; margin:0px;">'.LF;
...
#         }
         $html .='</td>'.LF;
#         if ($left_menue_status =='disapear'){
#            $html .=       '<td style="width:820px; vertical-align:bottom; padding-bottom:0px;">';
#         }else{

		  if($this->_environment->getCurrentFunction() == 'detail') {
          $html .=       '<td style="width:240px; vertical-align:bottom; padding-bottom:0px;">';
#         }
...
/*         $html .='<tr>'.LF;
         ...
         if ($left_menue_status =='disapear'){
            $html .=       '<td colspan="2" style="width:820px; vertical-align:bottom;">';
            ...
            $html .= '</div>'.LF;
            $html .='</td>'.LF;
            $html .=       '<td style="width:637px; vertical-align:bottom; padding-top:0px;">';
            $html .= '<div style=" margin:0px; padding-top:0px; padding-left:10px;">'.LF;
            $html .= '&nbsp;';
            $html .= '</div>'.LF;
         }
...
#         }
         ...
         if ( !empty($this->_views_right) ) {
            $html .= '<table style="width:100%; padding-top;0px;">'.LF;
            $html .= '<tr>'.LF;
...
#                }
#                if ($this->_shown_as_printable){
#                   $html .= $view->asPrintableHTML();
#                } else {
                   $html .= $view->asHTML();
#                }
                 $last_view = $view;
