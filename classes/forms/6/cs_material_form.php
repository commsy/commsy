...
class cs_material_form extends cs_rubric_form {
  ...
  /** constructor: cs_material_form
   ...
   function _initForm () {
      ...
      $temp_array['text'] = '*'.getMessage('MATERIAL_NO_BUZZWORDS');
      $temp_array['value'] = '-2';
      ...
      $temp_array['text'] = '*'.getMessage('MATERIAL_NO_TAGS');
      $temp_array['value'] = '-2';
      $this->_tag_array[] = $temp_array;
   ...
   function _createForm () {
      ...
      if ( $this->_bib_kind=='none' ) {
         $this->_form->addTextArea('description','',getMessage('MATERIAL_ABSTRACT'),'','',25);
      } else {
         $this->_form->addTextArea('description','',getMessage('MATERIAL_ABSTRACT'),'','',25);
      }
