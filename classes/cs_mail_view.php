...
class cs_mail_view extends cs_text_view {
    ...
    */
   function cs_mail_view ($environment, $with_modifying_actions=true) {
...
//      $html .= '<center>';
      $html .= '<table class="view_form" summary="Layout">'."\n";
      if (!empty($this->_title)) {
         $html .= '   <tr><td class="view_title">'."\n";
      ...
      $html .= '   <tr>'."\n";
      $html .= '      <td class="detail_view_content">'.$this->_text.'</td>'."\n";
      $html .= '   </tr>'."\n";
      $html .= '</table>'."\n";
//      $html .= '</center>';
