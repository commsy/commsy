 ...
 */
class cs_myroom_detail_view extends cs_context_detail_view {
    ...
    */
   function cs_myroom_detail_view ($environment, $with_modifying_actions=true,$creatorInfoStatus=array()) {
