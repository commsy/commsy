...
class cs_material_index_view extends cs_index_view {
    ...
    */
   function cs_material_index_view ($environment, $with_modifying_actions) {
...
/*********************/
   ...
   function _getListActionsAsHTML () {
      ...
      if ($current_user->isUser() and $this->_with_modifying_actions ) {
        $params = array();
        $params['iid'] = 'NEW';
        $html .= '> '.ahref_curl($this->_environment->getCurrentContextID(),CS_MATERIAL_TYPE,'edit',$params,$this->_translator->getMessage('COMMON_NEW_MATERIAL')).BRLF;
        unset($params);
     } else {
