...
class cs_home_member_page extends cs_left_page {

   function cs_home_member_page ($environment) {
   ...
   function execute () {
      ...
      include_once('classes/cs_home_member_form.php');
      $form = new cs_home_member_form($this->_environment);
