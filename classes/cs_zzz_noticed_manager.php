...
/** upper class of the zzz_noticed manager
 */
include_once('classes/cs_noticed_manager.php');
 ...
 */
class cs_zzz_noticed_manager extends cs_noticed_manager {
   public function __construct ($environment) {
      $this->_db_prefix = $environment->getConfiguration('c_db_backup_prefix').'_';
      parent::cs_noticed_manager($environment);
   }
}
?>