...
#         pr($form_element['name']);
      ...
      if (!$show_title_field){
         ...
         {
            case 'ACCOUNT_STATUS':
               $tempMessage = getMessage('COMMON_ACCOUNT_STATUS_FORM_TITLE');		// Status �ndern (Portal)
               break;
            ...
            case 'CONFIGURATION_DEFAULTS':
               $tempMessage = getMessage('COMMON_CONFIGURATION_DEFAULTS_FORM_TITLE');	// Voreinstellungen f�r R�ume OK
               break;
            ...
            case 'CONFIGURATION_LANGUAGE':
               $tempMessage = getMessage('COMMON_CONFIGURATION_LANGUAGE_FORM_TITLE');	// Verf�gbare Sprachen (Server)
               break;
            ...
            case 'CONFIGURATION_NEWS':
               $tempMessage = getMessage('COMMON_CONFIGURATION_NEWS_FORM_TITLE');      	// Ank�ndigungen bearbeiten (Portal)
               break;
            ...
            case 'CONFIGURATION_PORTALHOME':
               $tempMessage = getMessage('COMMON_CONFIGURATION_PORTALHOME_FORM_TITLE');	// Gestaltung der Raum�bersicht (Portal)
               break;
            ...
            case 'CONFIGURATION_ROOM_OPENING':
               $tempMessage = getMessage('COMMON_CONFIGURATION_ROOM_OPENING_FORM_TITLE');	// Raumer�ffnungen (Portal)
               break;
         ...
         $html .= '<h2 class="pagetitle">' . getMessage($tempMessage) . '</h2>';
