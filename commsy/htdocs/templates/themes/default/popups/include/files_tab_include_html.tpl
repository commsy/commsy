		...
		<div class="sa_col_left">
			...
			<div id="files_attached">
				{foreach $item.files as $file}
					<div style="float:left;"><input type="checkbox" checked="checked" name="form_data[file_{$file@index}]" value="{$file.file_id}" /></div><div name="file_name">{$file.file_name}</div><br/>
				{/foreach}
			</div>
