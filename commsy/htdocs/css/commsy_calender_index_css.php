...
div.calendar_entry {height: 40px; width:14%; float:left; background-color:#f0f0f0;}
div.calendar_entry_work {height: 40px; width:14%; float:left; background-color:#ffffff;}
