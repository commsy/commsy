...
if ( !empty($_SERVER["HTTP_HOST"]) ) {
   ...
   $c_commsy_domain = "http://172.16.56.128";
}
...
if ( !empty($_SERVER["SCRIPT_NAME"]) ) {
   ...
   $c_commsy_url_path = "/workspace/commsy/htdocs";
}
...
if ( !empty($_SERVER["SCRIPT_FILENAME"]) ) {
   ...
   $c_commsy_path_file = str_replace('/install','',$c_commsy_path_file);
   $c_commsy_path_file = str_replace('/',DIRECTORY_SEPARATOR,$c_commsy_path_file);
} else {
   $c_commsy_path_file = "/home/chris/sharedfolder/commsy";
}
$c_commsy_path_file = deleteLastSlash($c_commsy_path_file);

// security key
$c_security_key = "9d51861f7a8d97b1f1ef3fa95faa4ae5";
