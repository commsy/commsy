   ...
   elseif ( !empty($command) and isOption($command, $translator->getMessage('PREFERENCES_SAVE_BUTTON')) ) {
      ...
      if ($correct){
         ...
         if ( isset($_POST['color_choice'])) {
            ...
            }elseif ($_POST['color_choice']=='COMMON_COLOR_SCHEMA_21'){
               $color = $cs_color['SCHEMA_21'];
            }elseif ($_POST['color_choice']=='COMMON_COLOR_SCHEMA_22'){
            ...
            }elseif ($_POST['color_choice']=='COMMON_COLOR_SCHEMA_26'){
               $color = $cs_color['SCHEMA_26'];
