...
#      $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/highslide.css"/>'.LF;
 ...
 #        $retour .= '   <link rel="stylesheet" media="screen" type="text/css" href="css/external_portal_styles/'.$this->_environment->getCurrentContextID().'/css/ie70.css"/>'.LF;
   ...
   function _getUserPersonalAreaAsHTML () {
      ...
      $retour .= '         <select size="1" style="font-size:10pt; width:200px;" name="room_id" onChange="javascript:document.room_change.submit()">'.LF;
      $context_array = array();
   ...
   function getMyAreaAsHTML($wiki_url='') {
      ...
      if ( $this->_with_personal_area and empty($cs_mod)) {
         if ( !empty($this->_current_user) and ($this->_current_user->getUserID() == 'guest' and $this->_current_user->isGuest()) and !$this->_environment->inServer() ) {
            ...
            $html .= '<input type="text" name="user_id" size="100" style="font-size:10pt; width:100px;" tabindex="1"/>'.LF;
            $html .= '</td></tr>'.LF.'<tr><td><span class="T3">'.LF;
            $html .= $this->_translator->getMessage('MYAREA_PASSWORD').':'.'</span></td>'.LF.'<td>';
            $html .= '<input type="password" name="password" size="10" style="font-size:10pt; width:100px;" tabindex="2"/>'.'</td></tr>'.LF;
            ...
            $html .= '<input type="submit" name="option" style="width:112px;" value="'.$this->_translator->getMessage('MYAREA_LOGIN_BUTTON').'" tabindex="4"/>'.LF;
            $html .= '</td></tr>'.LF;
            $html .= '</table>'.LF;
            #$html .= '</div>'.LF;
...
$html .= '
    <div class="wrapper" style="height: 90px;">
        <div id="header">
            <a href="http://www.effective-webwork.de/" id="header_logo"><img src="http://www.effective-webwork.de/wp-content/themes/www.effective-webwork.de/img/effective_webwork.gif" alt=""></a> <!-- Link zur Startseite -->
            
            <ul id="main_navigation" class=""><li><a href="http://www.effective-webwork.de/" id="mn_home">Start</a></li>
<li><a href="http://www.effective-webwork.de/arbeitsweise/anspruch" class="mn_normal">Arbeitsweise</a></li>
<li><a href="http://www.effective-webwork.de/loesungen/webbasiertes-kliniknetzwerk" class="mn_normal">Lösungen</a></li>
<li><a href="http://www.effective-webwork.de/projekte/gesundheitsoziales" class="mn_normal">Projekte</a></li>
<li><a href="http://www.effective-webwork.de/kontakt/kontaktdatenformular" class="mn_normal_active">Kontakt</a></li>
</ul>            
        </div>
    ...
    <div style="background: url(http://www.effective-webwork.de/wp-content/uploads/2013/05/hd_contact_01.jpg) center top no-repeat;"> <!-- wird auf das Bild ueber dem Content abgestimmt, kann ordnerbezogen geaendert werden -->
        <div id="page_title_bg">
            <div class="wrapper">
                <h3>Extranet der effective WEBWORK</h3>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper">
        <div id="sec_navigation">
           <ul>
            <li><a href="http://www.effective-webwork.de/kontakt/kontaktdatenformular/">Kontaktdaten+Formular</a></li><li><a href="http://www.effective-webwork.de/kontakt/anfahrt/">Anfahrt</a></li><li><a href="http://www.effective-webwork.de/kontakt/ansprechpartner/">Ansprechpartner</a></li><li><a id="sec_active" href="http://commsy.effective-webwork.de/">Extranet</a></li><li><a href="http://www.effective-webwork.de/kontakt/impressum/">Impressum</a></li>            </ul>
            <div class="clear"></div>
        </div>
    </div>
...
if ((isset($cs_room_id) and !empty($cs_room_id) or ($current_user->isModerator()))){
	$html .='                            </div><div id="right_column">'.LF;
	$html .= $this->getMyAreaAsHTML();
...
$html.='
        ...
        <div class="wrapper">
            <div id="footer_col_left">
                ...
                <p>Sie erreichen uns von Montags bis Freitags
                telefonisch zwischen 9.00h und 17.00h</p>
                
                <strong id="btn_phone">040 / 60 94 08 57-0</strong><br>
                <a href="http://www.effective-webwork.de/kontakt" id="btn_message">Nachricht schreiben</a>
            </div>
            
            <div id="footer_col_right">
                <ul>
                    <li><a href="http://commsy.effective-webwork.de/">Extranet</a></li>
                    <li><a href="http://www.effective-webwork.de/kontakt/impressum">Impressum</a></li>
                    <li><a href="http://www.effective-webwork.de/kontakt/kontaktdatenformular">Kontakt</a></li>
                </ul>
                <a href="http://www.effective-webwork.de/"><img src="http://www.effective-webwork.de/wp-content/themes/www.effective-webwork.de/img/footer_logo.gif" alt=""></a> <!-- Link zur Startseite -->
            </div>
    ...
    <div id="copyright">
        <div class="wrapper">
        <p>© 2013 effective WEBWORK GmbH, alle Rechte vorbehalten</p>
        </div>
    </div>
		</body>
