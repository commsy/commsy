...
echo ('CommSy database, table log_error: the columns url and referer will be changed.'."\n");
$success = true;
$query  = "ALTER TABLE `log_error` ADD `url` VARCHAR( 255 ) NULL;";
$success = select($query);

$query  = "ALTER TABLE `log_error` ADD `referer` VARCHAR( 255 ) NULL;";
$success &= select($query);
