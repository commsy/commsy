 ...
 */
class cs_mylist_manager extends cs_labels_manager {
  ...
  /** constructor: cs_buzzword_manager
    ...
    */
  function cs_mylist_manager ($environment) {
  ...
  /** get an empty buzzword item
    ...
    */
   function getNewItem() {
      include_once('classes/cs_mylist_item.php');
      $item = new cs_mylist_item($this->_environment);
      return $item;
   }
}
?>