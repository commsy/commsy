define("commsy/Clipboard", [	"dojo/_base/declare",
        	"commsy/base",
        	"dojo/_base/lang",
        	"dojo/query",
        	"dojo/on",
	...
	return declare(BaseClass, {		
		...
		performRequest: function() {
			// send request
			this.AJAXRequest("clipboard", "performRequest", {}, Lang.hitch(this, function(response) {
				...
				dojo.forEach(response.list, Lang.hitch(this, function(room, index, arr) {
					// add headline
