		...
		registerPopupClick: function() {
			on(this.triggerNode, "click", lang.hitch(this, function(event) {
				if(this.is_open === false) {
					...
					this.AJAXRequest("rubric_popup", "getHTML", { module: this.module, iid: this.item_id, ref_iid: this.ref_iid, editType: this.editType }, lang.hitch(this, function(html) {
						// append html to body
						...
						on(document.body, "click", lang.hitch(this, function(event) {
							if(dom_attr.get(event.target, "id") === "popup_wrapper") {
								...
								alert("Bitte schließen Sie zuerst das Popup-Fenster, bevor Sie sonstige Seitenoperationen ausfÃ¼hren");
							}
						}));
