	...
	return {
		...
		onDomLoaded: function() {
			...
			if(this.getURLParam('fct') === 'detail') {
				...
				// workflow
				jQuery.merge(actors, jQuery('div[class="item_actions"] a[class="workflow"]'));
				jQuery.merge(objects, jQuery('div[class="content_item"] div[class^="fade_in_ground_workflow"]'));
