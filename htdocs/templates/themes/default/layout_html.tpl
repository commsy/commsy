...
{block name="site"}
	...
	<head>
		...
		<script src="javascript/commsy8_dojo/config.js?token=9"></script>
		<script src="javascript/commsy8_dojo/libs/dojo/dojo.js?token=9"></script>
		<script src="javascript/commsy8_dojo/main.js?token=9"></script>
