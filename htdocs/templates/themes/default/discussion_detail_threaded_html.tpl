		...
		<ul>
			{foreach $nodes as $node}
				<li	id="node_{$node.item_id}"
					...
					<div>
					<div class="discussion_threaded_tree_subject">{$node.subject}</div>
					<div class="discussion_threaded_tree_creator">{$node.creator}</div>
					<div class="discussion_threaded_tree_date">{$node.modification_date}</div></div>
