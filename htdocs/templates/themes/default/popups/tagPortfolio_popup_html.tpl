			...
			<div id="popup_inner" class="scrollPopup">
				...
				<div id="popup_content_wrapper">
					<div id="profile_content_row_three">
						...
						<input id="popup_button_delete" class="popup_button float-right submit" data-custom="action: 'delete'" type="button" name="" value="___COMMON_DELETE_BUTTON___" />
