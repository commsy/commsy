				...
				<div id="popup_tabs">
					...
					<div id="content_buttons">
						<div id="crt_actions_area">
							<input id="popup_button_create" class="popup_button" type="button" name="" value="{if $popup.edit == false}___ANNOUNCEMENT_SAVE_BUTTON___{else}___COMMON_ANNOUNCEMENT_EDIT___{/if}" />
