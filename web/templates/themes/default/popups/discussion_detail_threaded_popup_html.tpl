{extends file="discussion_detail_threaded_html.tpl"}
			...
			<div id="popup_frame">
				<div id="popup_inner" class="scrollPopup">
					...
					<div id="popup_pagetitle">
						...
						<a id="popup_detail_print" href="commsy.php?cid={$own.id}&mod=discussion&fct=detail&iid={$detail.item_id}&mode=print" title="___COMMON_LIST_PRINTVIEW___" target="_blank">
