...
final class Version20221005161630 extends AbstractMigration
{
    ...
    {
        return 'add slug to room, room_privat & zzz_room';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE room ADD slug VARCHAR(255) NULL;');
        $this->addSql('ALTER TABLE room_privat ADD slug VARCHAR(255) NULL;');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room_privat DROP COLUMN slug');
