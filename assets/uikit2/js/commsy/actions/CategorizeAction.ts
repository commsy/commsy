...
export class CategorizeAction extends XHRAction {
    ...
    public onPostLoadCustomFormData(backendResponse: ActionResponse): Promise<ActionResponse> {
        return new Promise<ActionResponse>((resolve) => {
            ...
            // insert form HTML with Select2Choice control containing available categories
            ...
            // listen to changes to the Select2Choice control and store IDs of all chosen categories as extra data
            let choices = [];
            let self = this;
