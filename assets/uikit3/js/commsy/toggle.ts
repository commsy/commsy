...
//
//   var toggleRef = UIkit.components.toggle.prototype.toggle;
//   UIkit.components.toggle.prototype.toggle = function() {
...
//   };
//
//   var initRef = UIkit.components.toggle.prototype.init;
//   UIkit.components.toggle.prototype.init = function() {
...
//     UIkit.$win.on('load orientationchange resize', UIkit.Utils.debounce((function(){
//
//       var fn = function() {
//         // check if the target has the "uk-hidden-small" class and is currently not visible
