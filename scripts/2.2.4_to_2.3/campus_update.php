...
function updateCampusItem () {
   ...
   while ( $row = mysql_fetch_array($result)) {
        ...
        if (substr_count($extras, '</COURSES_ARRAY>')>0 ) {
           echo '<br /><br />Das Array ist schon enthalten. Es werden keine Änderungen vorgenommen';
        } else {
           $extras = $extras.'<COURSES_ARRAY><NAME>courses</NAME>
	                           <DE><GENUS>F</GENUS>
	                           <NOMS>Veranstaltung</NOMS>
	                           <GENS>Veranstaltung</GENS>
	                           <AKKS>Veranstaltung</AKKS>
	                           <DATS>Veranstaltung</DATS>
	                           <NOMPL>Veranstaltungen</NOMPL>
	                           <GENPL>Veranstaltungen</GENPL>
	                           <AKKPL>Veranstaltungen</AKKPL>
	                           <DATPL>Veranstaltungen</DATPL>
	                           </DE>
	                           <EN><GENUS>F</GENUS>
	                           <NOMS>course</NOMS>
	                           <GENS>course</GENS>
