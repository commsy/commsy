...
echo ("This script deletes all old rubric translations in the extra field of all project rooms project.");

// count project rooms
$count = array_shift(mysql_fetch_row(mysql_query('SELECT COUNT(rooms.item_id) FROM rooms WHERE extras like "%TOPICS_ARRAY%"')));
init_progress_bar($count);

// get all rooms
$query = 'SELECT item_id, campus_id, extras FROM rooms WHERE extras like "%TOPICS_ARRAY%"';
