...
echo ('This script renames the PORTALWELLCOMETEXT to DESCRIPTION in extra-fields of portal and community.'."\n");
$success = true;
...
$count_rooms = $count_portal + $count_community;
if ($count_rooms < 1) {
   ...
   $extra = $row[1];
   while ($room_id) {
      if ( strstr($extra,'PORTALWELLCOMETEXTARRAY') ) {
         $extra = str_replace('PORTALWELLCOMETEXTARRAY','DESCRIPTION',$extra);
