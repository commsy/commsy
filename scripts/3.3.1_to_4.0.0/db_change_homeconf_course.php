...
echo ('This script cleans up the course forms of rubrics in the Extra-Field and replaces them with the new form'."\n");
$success = true;
...
if ($count_project < 1) {
   ...
   $extra = $row[1];
   while ($project_id) {
      $extra = str_replace('Veranstaltung', 'Lehrveranstaltung', $extra);
      // save project
