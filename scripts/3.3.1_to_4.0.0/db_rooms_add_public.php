...
echo ('This script adds a table field (public) to all rooms (projectroom [room] and communityroom [campus]).'."\n");
...
if (!in_array('public',$field_array)) {
   $query = "ALTER TABLE room ADD public TINYINT( 11 ) DEFAULT 0 NOT NULL AFTER type ;";
   $success = select($query);
}
