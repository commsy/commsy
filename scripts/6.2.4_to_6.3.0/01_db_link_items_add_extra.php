...
echo ('link_items add extras.'.LINEBREAK);
$success = true;
$query = "SHOW COLUMNS FROM link_items";
$result = select($query);
$column_array = array();
...
if ( in_array('extras',$column_array) ) {
   ...
   $query = "ALTER TABLE link_items ADD extras TEXT CHARACTER SET latin1 COLLATE latin1_german1_ci NULL;";
   $result = select($query);
   echo('done');
}
