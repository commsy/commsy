...
echo ('CommSy database, table log: insert post_content.'."\n");
$success = true;
$query  = 'ALTER TABLE log ADD post_content TEXT NULL AFTER request;';
...
// move configuration of ads from cs_config to database
echo ('CommSy database, table log_archive: insert post_content.'."\n");
$success = true;
$query  = 'ALTER TABLE log_archive ADD post_content TEXT NULL AFTER request;';
$success = select($query);
