...
echo ('This script creates a table to store temporally information about uploaded files'."\n");
if (mysql_fetch_row(select('SHOW TABLES LIKE "file_multi_upload" '))) {
   ...
   $query = "CREATE TABLE `file_multi_upload` (
