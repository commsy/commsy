...
$scripts[] = 'db_room_add_continuous';
$scripts[] = 'db_course_delete';
$scripts[] = 'db_room_add_template';
$scripts[] = 'db_log_rename_module';
$scripts[] = 'db_clean_links';
$scripts[] = 'db_remove_todo_teamcalendar';
...
$title = 'Master Update Script for CommSy Update 4.1.1 to 4.2.0';
