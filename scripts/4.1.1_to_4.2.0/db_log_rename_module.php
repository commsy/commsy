...
echo ('This script rename the mod column to module in the log table'."\n");
$success = true;

if (mysql_fetch_row(select('SHOW COLUMNS FROM log LIKE "module" '))) {
   echo "<br/>nothing to do."."\n";
   flush();
} else {
   $query = 'ALTER TABLE `log` CHANGE `mod` `module` VARCHAR( 250 ) DEFAULT NULL';
