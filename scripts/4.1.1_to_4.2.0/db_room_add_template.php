...
echo ('This script creates the column template in the room table'."\n");
$success = true;

echo ('room table:'."\n");
if (mysql_fetch_row(select('SHOW COLUMNS FROM room LIKE "template" '))) {
   echo "<br/>nothing to do."."\n";
   flush();
} else {
   echo ('creating continuous column:'."\n");
   $query = 'ALTER TABLE room ADD template TINYINT DEFAULT -1 NOT NULL';
