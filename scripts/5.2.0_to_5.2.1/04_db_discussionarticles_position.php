...
echo ('This script set the varchar of the field position of the table discussionarticles to 255.'."\n");
$success = true;
$query  = 'ALTER TABLE discussionarticles CHANGE position position VARCHAR(255) NOT NULL DEFAULT "1";';
