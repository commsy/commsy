...
class cs_context_manager extends cs_manager
{
    ...
    */
   public function setNotLockedLimit()
   {
   ...
   public function _getNewRoomItem($type)
   {
    ...
    public function getRelatedContextListForUserInt(
        ...
        if (!isset($this->listCache[$user_id.'_'.$auth_source.'_'.$context_id.'_'.$withExtras])) {
            ...
            if ('privateroom' !== $this->_room_type) {
            ...
            if (cs_userroom_item::ROOM_TYPE_USER !== $this->_room_type) {
    ...
    */
   public function getExtras($item_id)
   {
       $retour = [];
       if (!empty($item_id)
            and is_numeric($item_id)
   ...
   public function loadExtrasForContextArrayInCache($id_array)
   {
       $retour = [];
  ...
  public function _create($item)
  {
   ...
   public function getMaxActivityPointsInCommunityRoom($community_room_limit)
   {
       $retour = 0;
   ...
   public function getMaxActivityPointsInCommunityRoomInternal($community_room_array_limit)
   {
       $retour = 0;
   ...
   public function checkOptions($xml, $context_item, $options)
   {
