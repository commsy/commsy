...
class cs_community_item extends cs_room_item {
   ...
   */
   ...
   function setRoomContext ($value) {
      ...
      if ($value == 'uni'){
         $this->setHomeConf(CS_ANNOUNCEMENT_TYPE.'_short,'.CS_PROJECT_TYPE.'_short,'.CS_MATERIAL_TYPE.'_tiny,'.CS_USER_TYPE.'_tiny,'.CS_TOPIC_TYPE.'_short,'.CS_DISCUSSION_TYPE.'_tiny');
