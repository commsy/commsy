...
// Release $Name$
//
// Copyright (c)2002-2008 Matthias Finck, Dirk Fust, Oliver Hankel, Iver Jackewitz, Michael Janneck,
 ...
 */
class cs_announcement_short_view extends cs_home_view {
   ...
   function __construct($params) {
      ...
      $title = ahref_curl( $this->_environment->getCurrentContextID(),
                           ...
                           'index',
                           '',
                           $this->_translator->getMessage('COMMON_ANNOUNCEMENT_INDEX'),'','','','','','','class="head"');
   ...
   function _getItemAsHTML($item,$pos,$with_links=true) {
      ...
      $html .= '      <td '.$style.' style="font-size:8pt; width:20%;">'.$this->_getItemDate($item).'</td>'.LF;
      $html .= '      <td '.$style.' style="font-size:8pt; width:30%;" colspan="2">'.$this->_getItemModificator($item).'</td>'.LF;
      $html .= '   </tr>'.LF;
