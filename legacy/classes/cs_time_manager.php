...
class cs_time_manager extends cs_labels_manager
{
    ...
    public function getNewItem($label_type = ''): cs_time_item
    {
        $time = new cs_time_item($this->_environment);
        $time->makeSystemLabel();
        $time->setCreatorItem($this->_environment->getCurrentUser());
