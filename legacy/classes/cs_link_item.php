...
class cs_link_item extends cs_item
{
     ...
     * @param $object
     */
    public function setFirstLinkedItem($item)
    {
     ...
     *
     */
    public function setFirstLinkedItemID($value)
    {
     ...
     * @author CommSy Development Group
     */
    public function setSecondLinkedItem($item)
    {
     ...
     *
     */
    public function setSecondLinkedItemID($value)
    {
     ...
     * @author CommSy Development Group
     */
    public function setFirstLinkedItemType($type)
    {
     ...
     * @param string
     */
    public function setSecondLinkedItemType($type)
    {
     ...
     * @author CommSy Development Group
     */
    public function getFirstLinkedItem()
    {
     ...
     * @author CommSy Development Group
     */
    public function getSecondLinkedItem()
    {
     ...
     * @return $object
     */
    public function getLinkedItem($one_item)
    {
    ...
    public function getLinkedItemID($one_item)
    {
     ...
     * @author CommSy Development Group
     */
    public function getFirstLinkedItemType()
    {
     ...
     * @author CommSy Development Group
     */
    public function getSecondLinkedItemType()
    {
     ...
     * @author CommSy Development Group
     */
    public function getFirstLinkedItemID()
    {
     ...
     * @author CommSy Development Group
     */
    public function getSecondLinkedItemID()
    {
     ...
     * @author CommSy Development Group
     */
    public function getFirstLinkedItemVersionID()
    {
     ...
     * @author CommSy Development Group
     */
    public function getSecondLinkedItemVersionID()
    {
