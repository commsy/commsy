   ...
   function getSearchBoxAsHTML(){
      /*
                ...
                <div class="column_content">
                    ...
                    <form action="">
                        <label>Titel, Moderation, Beschreibung:</label>
      ...
      */
      ...
      $html .= '<div style="text-align:left; font-size: 8pt;"><label>'.$this->_translator->getMessage('PORTAL_SEARCH_FIELD').':</label>'.BRLF;
...
/*    $html .= '<body>';
    ...
    $html .= '        <ul>'.LF;
    $html .= '            <li><a href="/de/">Startseite</a></li>';
    $html .= '            <li><a href="/commsy/commsy.php?cid=276082" id="active">Raumliste</a></li>';
    $html .= '            <li><a href="/de/erste-schritte">Erste Schritte</a></li>';
    $html .= '            <li><a href="/de/hilfe">Hilfe</a></li>';
    $html .= '            <li><a href="/de/anwendungsbeispiele/">Anwendungsbeispiele</a></li>';
    $html .= '            <li><a href="/de/fortbildung/">Fortbildung</a></li>';
    $html .= '            <li><a href="/de/ansprechpartner/">Ansprechpartner</a></li>';
    $html .= '        </ul>'.LF;
    ...
    $html .= '        <img src="css/external_portal_styles/'.$current_context->getItemID().'/img/scs_claim.gif" alt="Moin beim SchulCommSy Hamburg" />'.LF;
    $html .= '    </div>'.LF;
...
# rechte Box, die zu füllen ist.
   ...
   $html .= '    <div id="maincontent">'.LF;
    ...
    $html .= '            <h2>Raumliste</h2>'.LF;
    $html .= '            <div class="column_content">'.LF;
       $html .= '         <div id="content">'.LF;
    }else{
   $html .= '    <div id="maincontent">'.LF;
    $html .= '        <div class="column_02" style="width:960px;">'.LF;
    $html .= '            <h2>Konfigurationsbereich</h2>'.LF;
    $html .= '            <div class="column_content">'.LF;
       $html .= '         <div id="content" style="width:924px;">'.LF;
    }
...
#    $html .= '   </div>'.LF;
    ...
    $html .= '            <ul>'.LF;
    $html .= '                <li><a href="http://www.hamburg.de/bsb" target="_blank" title="BSB Hamburg"><img src="css/external_portal_styles/'.$current_context->getItemID().'/img/partner_01.gif" alt="Beh&ouml;rde f&uuml;r Schule und Berufsbildung (BSB) " /></a></li>'.LF;
    $html .= '                <li><a href="http://li.hamburg.de" target="_blank" title="Li Hamburg"><img src="css/external_portal_styles/'.$current_context->getItemID().'/img/partner_02.gif" alt="Li Hamburg" /></a></li>'.LF;
    ...
    $html .= '        &copy;2012 SchulCommSy / effective webwork GmbH'.LF;
    $html .= '        <p id="footer_navigation">'.LF;
    $html .= '            <a href="">Kontakt</a> | <a href="">Impressum</a>'.LF;
    $html .= '        </p>'.LF;
    $html .= '        <div class="clear"> </div>'.LF;
