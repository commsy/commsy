 ...
 */
class cs_password_change_page_agora extends cs_password_change_page
{
    ...
    /** Overridden for the custom AGORA portal theme to provide a "change password" form view as HTML.
