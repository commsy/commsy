 ...
 */
class cs_home_member2_page_agora extends cs_home_member2_page
{
    ...
    /** Overridden for the custom AGORA portal theme to provide a "complete account" form view as HTML.
