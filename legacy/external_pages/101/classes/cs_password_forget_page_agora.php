 ...
 */
class cs_password_forget_page_agora extends cs_password_forget_page
{
    ...
    /** Overridden for the custom AGORA portal theme to provide a "forgotten password" form view as HTML.
