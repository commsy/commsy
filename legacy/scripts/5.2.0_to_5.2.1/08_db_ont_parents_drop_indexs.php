...
$success = true;
$query  = 'ALTER TABLE ont_parents DROP INDEX direct_parent;';
$success = select($query);

$query  = 'ALTER TABLE ont_parents DROP INDEX ontology_id;';
$success &= select($query);

$query  = 'ALTER TABLE ont_parents DROP INDEX parent_id;';
$success &= select($query);

$query  = 'ALTER TABLE ont_parents DROP INDEX child_id;';
$success &= select($query);
