...
/**
 * Deletes a `userroom` (personal work area inside a project). Replaces
 * `cs_userroom_item::delete()`. The simplest room flavour: no sub-rooms,
 * no link bookkeeping, no mirrored label entity, no moderation mail, and
 * not indexed in ES. Unlike legacy, content and memberships are cleaned
 * up explicitly here rather than relying on per-user footprint erasure.
 */
