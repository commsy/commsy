 ...
 * LinkItems
 *
 * @ORM\Table(name="link_items", indexes={@ORM\Index(name="context_id", columns={"context_id"}), @ORM\Index(name="creator_id", columns={"creator_id"}), @ORM\Index(name="first_item_id", columns={"first_item_id"}), @ORM\Index(name="second_item_id", columns={"second_item_id"}), @ORM\Index(name="first_item_type", columns={"first_item_type"}), @ORM\Index(name="second_item_type", columns={"second_item_type"}), @ORM\Index(name="deletion_date", columns={"deletion_date"}), @ORM\Index(name="deleter_id", columns={"deleter_id"})})
 * @ORM\Entity
 */
class LinkItems
{
