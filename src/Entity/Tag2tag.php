 ...
 * Tag2tag
 *
 * @ORM\Table(name="tag2tag", indexes={@ORM\Index(name="from_item_id", columns={"from_item_id"}), @ORM\Index(name="context_id", columns={"context_id"}), @ORM\Index(name="deletion_date", columns={"deletion_date"}), @ORM\Index(name="deleter_id", columns={"deleter_id"})})
 * @ORM\Entity
 */
class Tag2tag
{
