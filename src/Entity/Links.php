 ...
 * Links
 *
 * @ORM\Table(name="links", indexes={@ORM\Index(name="context_id", columns={"context_id"}), @ORM\Index(name="link_type", columns={"link_type"}), @ORM\Index(name="from_item_id", columns={"from_item_id"}), @ORM\Index(name="from_version_id", columns={"from_version_id"}), @ORM\Index(name="to_item_id", columns={"to_item_id"}), @ORM\Index(name="to_version_id", columns={"to_version_id"})})
 * @ORM\Entity
 */
class Links
{
