...
/**
 * ZzzHomepageLinkPagePage
 *
 * @ORM\Table(name="zzz_homepage_link_page_page", indexes={@ORM\Index(name="from_item_id", columns={"from_item_id"}), @ORM\Index(name="context_id", columns={"context_id"}), @ORM\Index(name="to_item_id", columns={"to_item_id"})})
 * @ORM\Entity
 */
class ZzzHomepageLinkPagePage
{
    /**
     * @var integer
     *
