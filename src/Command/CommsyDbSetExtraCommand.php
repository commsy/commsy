...
#[AsCommand(
    name: 'commsy:db:set-extra',
    description: 'Updates values in the extra column of an entity',
)]
class CommsyDbSetExtraCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($query->toIterable() as $entity) {
            if (method_exists($entity, 'getExtras') && method_exists($entity, 'setExtras')) {
                ...
                $extras[$input->getArgument('name')] = $input->getArgument('value');
