...
class SectionType extends AbstractType
{
    ...
    {
        $builder
            ->add('title', TextType::class, ['constraints' => [new NotBlank()], 'label' => 'Title', 'attr' => ['placeholder' => $options['placeholderText'], 'class' => 'uk-form-width-medium'], 'translation_domain' => 'material'])
