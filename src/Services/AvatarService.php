...
{    
    ...
    function generateAvatar() {
        ...
        return file_get_contents($this->kernelRootDir.'/../assets/uikit2/img/user_unknown.gif');
    }
    
    function generateInitialsAvatar() {
        if ($this->type == 1) {
            $image = @imagecreatefromgif($this->kernelRootDir.'/../assets/uikit2/img/user_unknown.gif');
            $imageSize = getimagesize($this->kernelRootDir.'/../assets/uikit2/img/user_unknown.gif');
        ...
        $font = $this->kernelRootDir.'/../assets/uikit2/fonts/LiberationSans-Regular.ttf';
        $angle = 0;
