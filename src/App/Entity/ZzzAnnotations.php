 ...
 * ZzzAnnotations
 *
 * @ORM\Table(name="zzz_annotations", indexes={@ORM\Index(name="context_id", columns={"context_id"}), @ORM\Index(name="creator_id", columns={"creator_id"}), @ORM\Index(name="linked_item_id", columns={"linked_item_id"})})
 * @ORM\Entity
 */
class ZzzAnnotations
{
    /**
     * @var integer
     *
