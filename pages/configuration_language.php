...
if ($command != 'error') {
   ...
   // Show form and/or save item
      ...
      // Initialize the form
      include_once('classes/cs_configuration_language_form.php');
      $form = new cs_configuration_language_form($environment);
      // display form
      $params = array();
      $params['environment'] = $environment;
      $params['with_modifying_actions'] = true;
      ...
      if ( !empty($command) and isOption($command, getMessage('PREFERENCES_SAVE_BUTTON') ) ) {
         ...
         if ( $correct ) {
            ...
            if ( !empty($_POST['languages']) ) {
               $context_item->setAvailableLanguageArray($_POST['languages']);
            }
