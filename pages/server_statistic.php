...
if (!$current_user->isRoot()) {
   include_once('functions/error_functions.php');trigger_error('current user is not root',E_USER_ERROR);
} else {
   ...
   // get all CommSys (communty rooms)
   $commsy_manager = $environment->getCommunityManager();
   $commsy_manager->select();
   $commsy_list = $commsy_manager->get();
   ...
   // Set data for view
   $statistic_view->setList($commsy_list);
