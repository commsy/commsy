...
// Access granted
   ...
   // Initialize the form
   include_once('classes/cs_configuration_rubric_form.php');
   $form = new cs_configuration_rubric_form($environment);
   include_once('classes/cs_configuration_rubric_form_view.php');
   $form_view = new cs_configuration_rubric_form_view($environment);
