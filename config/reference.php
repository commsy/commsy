 ...
 *         index_patterns?: list<scalar|null>,
 *         client?: scalar|null,
 *         settings?: mixed, // Default: []
 *         date_detection?: bool,
 *         dynamic_date_formats?: list<scalar|null>,
 ...
 *     listeners?: array{
 *         doctrine_orm?: bool, // Default: true
 *     },
 *     where_method?: scalar|null, // Defined the doctrine query builder method the bundle will use to add the entire filter condition. // Default: "and"
 *     condition_pattern?: scalar|null, // Default condition pattern for TextFilterType // Default: "text.starts"
 *     force_case_insensitivity?: bool, // Whether to do case insensitive LIKE comparisons. // Default: false
 *     encoding?: scalar|null, // Encoding for case insensitive LIKE comparisons. // Default: null
 * }
 ...
 *     private?: bool, // Change cache headers so the RSS feed is not cached by public caches (like reverse-proxies...). // Default: false
 *     force_refresh?: bool, // Do not send 304 status if the feed has not been modified since last hit // Default: false
 *     content_type_json?: scalar|null, // Content-Type header value to use for json feed generation. // Default: "application/json"
 *     content_type_xml?: scalar|null, // Content-Type header value to use for xml feed generation (atom and rss). // Default: "application/xhtml+xml"
 *     date_formats?: list<scalar|null>,
 * }
 * @psalm-type WhiteOctoberBreadcrumbsConfig = array{
 *     separator?: scalar|null, // Default: "/"
 *     separatorClass?: scalar|null, // Default: "separator"
 *     listId?: scalar|null, // Default: "wo-breadcrumbs"
 *     listClass?: scalar|null, // Default: "breadcrumb"
 *     itemClass?: scalar|null, // Default: ""
 *     linkRel?: scalar|null, // Default: ""
 *     locale?: scalar|null, // Default: null
 *     translation_domain?: scalar|null, // Default: null
 *     viewTemplate?: scalar|null, // Default: "@WhiteOctoberBreadcrumbs/microdata.html.twig"
 * }
