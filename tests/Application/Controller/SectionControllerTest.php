...
class SectionControllerTest extends AbstractApplicationTestCase
{
    ...
    public function testXhrDeleteAcceptsXmlHttpRequest(): void
    {
        ...
        // over an empty set and returns a JSON response — this still exercises
        // the full controller path (getRoom, getItemsForActionRequest, execute).
        $this->client->request(
            'POST',
