...
INSERT INTO `items` VALUES (98,99,'user',NULL,NULL,NULL,NULL,0),(99,0,'server',NULL,NULL,'2014-08-19 15:38:16',NULL,0);
...
CREATE TABLE `portal` (
  ...
  `project_show_deactivated_entries_title` tinyint(1) NOT NULL DEFAULT 1,
  `community_show_deactivated_entries_title` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-08-04 12:39:34
