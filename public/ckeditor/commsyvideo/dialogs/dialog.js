                                    ...
                                    children: [
                                        {
                                            type: 'file',
                                            id: 'upload',
                                            label: editor.lang.commsyvideo.uploadnew + '<br/>' + '<span style="font-size: 9px;color: red;">' + editor.lang.commsyvideo.uploadnewlegend.replace('<quantity_reeplace>', editor.config.maxUploadSize/(1024*1024)) + '</span>',
                                            onChange: function () {
